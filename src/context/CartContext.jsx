...
// Función para obtener imágenes de la carpeta assets
function getImageUrl(name) {
  return new URL(`../activos/productos/${name}`, import.meta.url).href;
}
...
const rawProducts = [
  ...
  { id: 18, name: 'Mousepad Gamer Corsair MM300 PRO Extended XL', oldPrice: 29.99, price: 29.99, discountPercent: 0, isOffer: false, stock: 20, description: 'Superficie de tela a prueba de derrames con bordes cosidos.', image: getImageUrl('alfombrilla de ratón18.png') },
  ...
  { id: 20, name: 'Webcam Logitech C920 HD Pro 1080p', oldPrice: 69.99, price: 69.99, discountPercent: 0, isOffer: false, stock: 14, description: 'Videollamadas Full HD con micrófono estéreo doble y corrección de luz.', image: getImageUrl('cámara20.png') }
];
