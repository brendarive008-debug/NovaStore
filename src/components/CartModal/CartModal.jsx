...
const CartModal = forwardRef((props, ref) => {
  ...
  const handleAplicarCupon = () => {
    ...
    if (
      ...
      alert(
        'Cupón no válido. Prueba con NOVA10.'
      );
  ...
  const handleSubmit = (e) => {
    ...
    const compra = {
      ...
      customer: datosEnvio.nombre,
      address: datosEnvio.direccion,
